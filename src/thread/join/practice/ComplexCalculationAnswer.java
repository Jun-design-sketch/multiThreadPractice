...
public class ComplexCalculationAnswer {
    public static void main(String[] args) throws InterruptedException {
        BigInteger answer = calculateResult(BigInteger.valueOf(10L), BigInteger.valueOf(3L), BigInteger.valueOf(10L), BigInteger.valueOf(1L));
